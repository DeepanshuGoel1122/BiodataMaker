...
export default function ExecutivePremiumTemplate() {
  ...
  return (
    <div className="w-full h-full flex font-sans text-[var(--theme-text)] shadow-xl overflow-hidden bg-white" style={{ width: '210mm', minHeight: '297mm', margin: '0 auto' }}>
      ...
      <div className="w-[35%] h-full shrink-0 flex flex-col p-8 relative z-10" style={{ backgroundColor: 'var(--theme-primary)' }}>
        ...
        {/* Profile Photo */}
        {imageUrl && (
          <div className="w-full mb-10 flex justify-center relative z-20">
            <div className="p-1.5 bg-white/20 backdrop-blur-sm rounded-lg shadow-xl w-full max-w-[200px] aspect-square">
      ...
      {/* Main Content Area */}
      <div className="w-[65%] h-full flex flex-col px-10 py-12 relative bg-[var(--theme-bg)]">
        
        {/* Header Content */}
        <div className="mb-12 border-b-2 pb-6" style={{ borderColor: 'var(--theme-primary)' }}>
        ...
        {/* Dynamic Sections */}
        <div className="flex-1 space-y-8 print-avoid-break">
